...
export const SEO_ROUTES: Record<string, RouteSeoConfig> = {
  '/': {
    path: '/',
    title: 'Hikari no Matsuri Vol. 3 | Japanese & Anime Festival | Chennai',
    description: 'Join Hikari no Matsuri Vol. 3 on January 8, 2027 at Chennai Institute of Technology in Chennai. Celebrate Japanese culture, anime, cosplay, music, and food.',
    ogType: 'event',
    canonicalPath: '/',
    isIndexable: true,
    changefreq: 'daily',
    ...
    jsonLd: (baseUrl: string) => ({
      ...
      location: {
        '@type': 'Place',
        name: 'Chennai Institute of Technology Campus (CIT) Exhibition Grounds',
        address: {
          '@type': 'PostalAddress',
      ...
      organizer: {
        '@type': 'Organization',
        name: 'Lumos (Student Community of CIT) & Isshoni Nihongo',
        url: `${baseUrl}/club`,
      },
      offers: [
        {
